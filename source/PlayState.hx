...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'jazz-cup-remix':
				songLowercase = 'jazzcupremix';
			case 'neon-remix':
				songLowercase = 'neonremix';
			case 'lost-remix':
				songLowercase = 'lostremix';
		}
		...
		if (SONG.stage == null)
		{
			switch (storyWeek)
			{
				...
				case 3:
					if (songLowercase == 'neon remix')
					{
						stageCheck = 'gzmalln';
					}
					if (songLowercase == 'lost remix')
					{
						stageCheck = 'gzmalld';
					}
					else
         ...
         switch (SONG.player2)
           {
			 ...
			 case 'maggie' | 'maggie-doom':
              healthBar.createFilledBar(0xFFFFB3E5, 0xFF0097C4);
            }
        }
        else
	...
	function schoolIntro(?dialogueBox:DialogueBox):Void
	{
		...
		if (StringTools.replace(PlayState.SONG.song, " ", "-").toLowerCase() == 'roses'
			...
			|| StringTools.replace(PlayState.SONG.song, " ", "-").toLowerCase() == 'neon'
			|| StringTools.replace(PlayState.SONG.song, " ", "-").toLowerCase() == 'lost'
			|| StringTools.replace(PlayState.SONG.song, " ", "-").toLowerCase() == 'neon-remix'
			|| StringTools.replace(PlayState.SONG.song, " ", "-").toLowerCase() == 'lost-remix')
		{
			remove(black);
	...
	function startCountdown():Void
	{
		...
		startTimer = new FlxTimer().start(Conductor.crochet / 1000, function(tmr:FlxTimer)
		{
			...
			introAssets.set('doom', ['doomui/ready-doom', 'doomui/set-doom', 'doomui/go-doom']);
			...
			if (SONG.noteStyle == 'doom')
			{
				introAlts = introAssets.get('doom');
				altSuffix = '-doom';
				week6Bullshit = 'remixui';
			}
	...
	function endSong():Void
	{
		...
		if (SONG.validScore)
		{
			...
			switch (songHighscore)
			{
				...
				case 'Jazz-Cup-Remix':
					songHighscore = 'Jazzcupremix';
				case 'Neon-Remix':
					songHighscore = 'Neonremix';
				case 'Lost-Remix':
					songHighscore = 'Lostremix';
			}
				...
				else
				{
					...
					switch (songFormat)
					{
						...
						case 'Jazz-Cup':
							songFormat = 'Jazzcup';
						case 'Jazz-Cup-Remix':
							songFormat = 'Jazzcupremix';
						case 'Neon-Remix':
							songFormat = 'Neonremix';
						case 'Lost-Remix':
							songFormat = 'Lostremix';
					}
	...
	private function popUpScore(daNote:Note):Void
	{
		...
		if (daRating != 'shit' || daRating != 'bad')
		{
			...
			if (SONG.noteStyle == 'doom')
			{
				pixelShitPart1 = 'doomui/';
				pixelShitPart2 = '-doom';
				pixelShitPart3 = 'remixui';
			}

...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		if (PlayState.SONG.song.toLowerCase()=='senpai' || PlayState.SONG.song.toLowerCase()=='roses' || PlayState.SONG.song.toLowerCase()=='thorns')
			...
			if (PlayState.SONG.song.toLowerCase()=='jazz cup' || PlayState.SONG.song.toLowerCase()=='neon' || PlayState.SONG.song.toLowerCase()=='lost')
			{
			...
			if (PlayState.SONG.song.toLowerCase()=='jazz cup remix' || PlayState.SONG.song.toLowerCase()=='neon remix' || PlayState.SONG.song.toLowerCase()=='lost remix')
			{
				portraitLeft = new FlxSprite(-20, 0);
		...
		if (!talkingRight)
		{
			//if this code is commented out, it's because I fucked up.
			//Doesn't work.
			/*
			if (PlayState.SONG.song.toLowerCase()=='jazz cup' || PlayState.SONG.song.toLowerCase()=='neon' || PlayState.SONG.song.toLowerCase()=='lost')
			{
				boxright.frames = Paths.getSparrowAtlas('meme/bf_text_bubbles');
			}
			if (PlayState.SONG.song.toLowerCase()=='jazz cup remix' || PlayState.SONG.song.toLowerCase()=='neon remix' || PlayState.SONG.song.toLowerCase()=='lost remix')
			{
				boxright.frames = Paths.getSparrowAtlas('doom/bf_text_bubbles');
			}
			if (PlayState.SONG.song.toLowerCase()=='chug jug with you' || PlayState.SONG.song.toLowerCase()=='ringside')
			{
				boxright.frames = Paths.getSparrowAtlas('modstuff/bf_text_bubbles');
			}*/
			//the code under here does work, though...
			// box.flipX = true;
		}

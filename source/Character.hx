...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'maggie':
				frames = Paths.getSparrowAtlas('Maggie_Assets', 'shared', true);
				...
				playAnim('idle');
			case 'bf-doom':
				var tex = Paths.getSparrowAtlas('BOYFRIENDGZP', 'shared', true);
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
				...
				flipX = true;
			case 'bf-doom-dead':
				var tex = Paths.getSparrowAtlas('BOYFRIENDGZPDEAD', 'shared', true);
				frames = tex;
				...
				flipX = true;
			case 'gf-doom':
				tex = Paths.getSparrowAtlas('GFGZP_assets', 'shared', true);
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
				...
				playAnim('danceRight');
			case 'maggie-doom':
				frames = Paths.getSparrowAtlas('MaggieGZP_Assets', 'shared', true);
			...
			//Kade Engine 1.7 compatible now, even though it's commented out.
			/*
			case 'tankman':
				...
				//goes in tankmanOffsets.txt (Not final offsets)
				idle -5 0
				singUP 44 52
				singRIGHT 22 -24
				singLEFT 80 -7
	...
	public function dance(forced:Bool = false, altAnim:Bool = false)
	{
		if (!debugMode)
		{
			switch (curCharacter)
			{
				case 'gf' | 'gf-christmas' | 'gf-car' | 'gf-pixel' | 'gf-doom':
...
>>>>>>> 632b769465f8f43ee1825fa4e7ede7a8b45ae057
